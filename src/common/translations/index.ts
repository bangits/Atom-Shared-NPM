...
export default {
  ...
  ggrAmountFrom: 'GGR Amount From',
  ggrAmountTo: 'GGR Amount To',
  ggrPercent: 'GGR (%)',
  ...
  isRecalculated: 'Is Recalculated',
  browser: 'Browser',
  sumOf: 'Sum Of',
  ...
  correctCasinoBalance: 'Correct Casino Balance',
  windraw: 'WithDraw',
  deposit: 'Deposit',
  rgsId: 'RGS ID',
  platId: 'Plat ID',
  ...
  generatedDepositAmountTo: 'Generated Deposit Amount To',
  generatedDepositAmountFrom: 'Generated Deposit Amount From',
  generatedDepositAmount: 'Generated Deposit Amount',
  generatedDepositCountTo: 'Generated Deposit Count To',
  generatedDepositCountFrom: 'Generated Deposit Count From',
  generatedDepositCount: 'Generated Deposit Count',
  ...
  doYouWantToActivate: 'Do you want to activate',
  ...
  disablePromoDescription: 'Do you want to disable the campaign',
  disablePromoMultiDescription: 'Do you want to disable',
  ...
  emailButtonTooltipText:
    'Name button text for it to appear in email text. Please note, button text in Email template should be replaced with {@buttontext} variable.',
  emailButtonTooltipUrl:
    'Enter button URL for it to appear in email text. Please note, button URL in Email template should be replaced with {@buttonurl} variable.',
  youDontHaveLeadsAdded: 'You Dont Have Leads Added',
  pleaseAddLead: 'Please Add Lead',
  campaigns: 'Campaigns',
  campaignSuccessfullyAdded: 'Campaign Successfully Added',
  scheduled: 'Scheduled',
  ...
  commissionByGgr: 'Commission By GGR',
  commissionByFtd: 'Commission By FTD',
  numberOfCodesTooltipText: 'The number of generated codes cannot be exceeded Promo Campaign codes quantity',
  generatingPromocodes: 'Generating Promocodes...',
  promocodesGenerationMaxIsReached: 'Promocodes generation maximum is reached!',
  generationDateTo: 'Generation Date To',
  unused: 'Unused',
  ...
  withdraw: 'Withdraw',
  commissionByDeposit: 'Commission By Deposit',
  ...
  originalBetAmountFrom: 'Original Bet Amount From',
  originalBetAmountTo: 'Original Bet Amount To',
  odds: 'Odds',
  betType: 'Bet Type',
  eventType: 'Event Type',
  systemMin: 'System Min',
  possibleWinningAmount: 'Possible Winning Amount',
  possibleWinAmount: 'Possible Win Amount',
  winningEvents: 'Winning Events (Min)',
  originalGGR: 'Original GGR',
  externalBetId: 'External Bet Id',
  'ggr%': 'GGR %',
  express: 'Express',
  combined: 'Combined',
  live: 'Live',
  ...
  originalWinAmount: 'Original Win Amount',
  originalWinAmountFrom: 'Original Win Amount From',
  originalWinAmountTo: 'Original Win Amount To',
  originalGGRFrom: 'Original GGR From',
  originalGGRTo: 'Original GGR To',
  ...
  paymentProviderInActivationSuccess: `Successfully inactivated ${TRANSLATION_CHANGED_VALUE} provider(s)!`,
  ...
  paymentMethodActivationSuccess: `Successfully activated ${TRANSLATION_CHANGED_VALUE} method(s)!`,
  paymentMethodInActivationSuccess: `Successfully inactivated  ${TRANSLATION_CHANGED_VALUE} method(s)!`,
  cmsPaymentMethodActivationSuccess: `Successfully activated ${TRANSLATION_CHANGED_VALUE} payment method(s)!`,
  cmsPaymentMethodActivationFail: `Failed to activate ${TRANSLATION_CHANGED_VALUE} payment method(s). Please check the settings of methods!`,
  cmsPaymentMethodInActivationSuccess: `Successfully inactivated  ${TRANSLATION_CHANGED_VALUE} payment method(s)!`,
  ...
  moreThanMaxCountPerAccountDaily: 'Value should be more than Max Count Per Account(Daily).',
  ...
  frozenBalanceFrom: 'Frozen Balance From',
  frozenBalanceTo: 'Frozen Balance To',
  unusedBalanceFrom: 'Unused Balance From',
  unusedBalanceTo: 'Unused Balance To',
  playerBalances: 'Player Balances',
  totalBalanceFrom: 'Total Balance From',
  totalBalanceTo: 'Total Balance To',
  unplayedBalance: 'Unplayed Balance',
  unplayedBalanceFrom: 'Unplayed Balance From',
  unplayedBalanceTo: 'Unplayed Balance To',
  playedBalance: 'Played Balance',
